...
namespace _26311012_KimMinJun_Resume
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("학");
            Console.SetCursorPosition(Size_Paper / 30, Cursor_Position_y + 1);
            Console.Write("력");
            Console.SetCursorPosition(Size_Paper / 30, Cursor_Position_y + 2);
            Console.Write("사");
            Console.SetCursorPosition(Size_Paper / 30, Cursor_Position_y + 3);
            Console.Write("항");
